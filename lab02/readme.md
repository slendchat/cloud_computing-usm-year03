...
![Забекапил стартовую страницу](img/before_moving_website.png)
...
- Проблема была в том что конфиг подготовлен для дебиан бэйзд дистрибутива при котором пути в редхат бейзд ломаются, надо было просто исправить пути.
